...
const NAVIGATION_RESPONSES = {
  ...
  hi: {
    ...
    agriBuddy: "आपकी फसल यात्रा और एआई सहायक के लिए एग्रीबडी खोल रहा हूं।"
  },
  or: {
    home: "ମୁଁ ଆପଣଙ୍କୁ ହୋମ ଡ୍ୟାସବୋର୍ଡକୁ ନେଇଯାଉଛି ଯେଉଁଠାରେ ଆପଣ ସମସ୍ତ କୃଷି ସୁବିଧା ଦେଖିପାରିବେ।",
    ...
    agriBuddy: "ଆପଣଙ୍କ ଫସଲ ଯାତ୍ରା ଏବଂ ଏଆଇ ସହାୟକ ପାଇଁ ଆଗ୍ରୀବଡି ଖୋଲୁଛି।"
  },
  bn: {
    ...
    agriBuddy: "আপনার ফসল যাত্রার জন্য এবং এআই সহায়কের জন্য আগ্রীবাডি খুলছি।"
  },
  te: {
    home: "నేను మిమ్మల్ని హోమ్ డ్యాష్‌బోర్డ్‌కు తీసుకెళ్తాను అక్కడ మీరు అన్ని వ్యవసాయ లక్షణాలను చూడవచ్చు।",
    ...
    agriBuddy: "మీ పంట ప్రయాణం కోసం మరియు ఎఐ సహాయకుడికి అగ్రీబడీని తెరుస్తున్నాను."
  },
  ta: {
    ...
    agriBuddy: "உங்கள் பயிர் பயணத்திற்காக மற்றும் எஐ உதவியாளருக்காக அக்ரீபடியைத் திறக்கிறேன்."
  },
  mr: {
    ...
    agriBuddy: "तुमच्या पीक प्रवासासाठी आणि एआय सहाय्यकासाठी अॅग्रीबडी उघडत आहे."
  },
  gu: {
    ...
    agriBuddy: "તમારા પાક પ્રવાસ માટે અને એઆઈ સહાયક માટે એગ્રીબડી ખોલી રહ્યો છું."
  }
};
