  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (farmSize && isNaN(parseFloat(farmSize))) {
        toast.error('Farm size must be a valid number');
        return;
      }
      ...
      // Prepare the profile data with proper validation
      ...
      if (error.code === 'permission-denied') {
        toast.error('Permission denied. You may not have access to update your profile.');
